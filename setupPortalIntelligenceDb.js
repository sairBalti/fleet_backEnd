...
const roleRules = {
  ...
  ConstructionAdmin: [/^\/dashboard\//, /^\/businesses\/(live|targets)$/, /^\/fleet\//, /^\/reports\//, /^\/driver\//, /^\/maintenance$/, /^\/trips$/, /^\/chat$/, /^\/settings\//, /^\/helpdesk$/],
  ProjectManager: [/^\/dashboard\//, /^\/fleet\//, /^\/reports\//, /^\/driver\//, /^\/maintenance$/, /^\/trips$/, /^\/chat$/, /^\/settings\/account$/, /^\/helpdesk$/],
  SiteEngineer: [/^\/dashboard\//, /^\/fleet\//, /^\/driver\//, /^\/maintenance$/, /^\/trips$/, /^\/chat$/, /^\/helpdesk$/],
  Supervisor: [/^\/dashboard\//, /^\/fleet\/inspection$/, /^\/driver\/schedule$/, /^\/trips$/, /^\/chat$/, /^\/helpdesk$/],
  Accountant: [/^\/dashboard\//, /^\/reports\//, /^\/helpdesk$/],
  Contractor: [/^\/dashboard\//, /^\/driver\/schedule$/, /^\/trips$/, /^\/chat$/, /^\/helpdesk$/],
  Worker: [/^\/dashboard\//, /^\/driver\/schedule$/, /^\/trips$/, /^\/chat$/, /^\/helpdesk$/],
